...
!define PRODUCT_NAME "Freya"
!define PRODUCT_PUBLISHER "Freya"
...
!define MUI_ICON "..\Freya\Resources\favicon.ico"
!define MUI_UNICON "${NSISDIR}\Contrib\Graphics\Icons\modern-uninstall.ico"

Function .onInit
   ${If} ${RunningX64}
      StrCpy $INSTDIR "$PROGRAMFILES64\Freya"
   ${Else}
      StrCpy $INSTDIR "$PROGRAMFILES\Freya"
   ${EndIf}
FunctionEnd
...
; It is pretty clear what following line does: just rename the file name to your project startup executable.
  CreateShortCut "$DESKTOP\${PRODUCT_NAME}.lnk" "$INSTDIR\Freya.exe" ""
SectionEnd
...
Function un.onInit
  MessageBox MB_ICONQUESTION|MB_YESNO|MB_DEFBUTTON2 "Are you sure you want to completely remove Freya and all of its components?" IDYES +2
  Abort
FunctionEnd
